...
- [Symbol maps for the Download Play child executables](https://tcrf.net/images/8/89/MK7_Download_Play_Child_Symbol_Maps.zip)
   * Additionally, you can find [the symbol maps for Nintendogs + cats here](https://tcrf.net/File:NintendogsCats_Symbol_Maps.zip).<br>
...
- [Version table](https://docs.google.com/spreadsheets/d/1tjbaPn8k-6oe--BmxkvZLP1WWRtDMBun8AKfAPmcGW8/edit?gid=0#gid=0)

- Related Discord servers:
   * [Mario Kart 7 TCRF server](https://discord.gg/RAcJShncQ4)
   * [3DS Game Decompilation server](https://discord.gg/dFgw7CwrEX)
